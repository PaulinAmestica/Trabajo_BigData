...
##GRAFICOS SEGUN LA PLATAFORMA PARA UTILIZAR EL JUEGO##
library(ggplot2)
ggplot(Investigacionfinal, aes(x = plataforma, y = PrecioJuegos)) +
geom_point()

##SEGUN LOS DATOS OBTENIDOS POR LOS GRAFICOS EL PRECIO DE LOS JUEGOS ES UN TANTO PARECIDAD##
##PERO LOS JUEGOS DE PS4 ES MAS ALTO QUE EL DE XBOX ONE##

##GRAFICOS SEGUN LA TIENDA EN LA QUE SE COMPRA EL JUEGO##
ggplot(Investigacionfinal, aes(x = tienda, y = PrecioJuegos)) +
  geom_point()

##SEGUN LOS DATOS OBTENIDOS POR LOS GRAFICOS EL PRECIO DE LOS JUEGOS ES DIFERENTE SEGÚN LA TIENDA##
##EN LA QUE SE COMPRE, EN ZMART LOS PRECIOS SON MÁS VARIADOS Y EN PARIS LOS PRECIOS SON MAS PARECIDOS##



#install.packages("xlsx")
library(xlsx)
# PASAR BASE DE DATOS DE "R" A "EXCEL"
write.xlsx(Investigacionfinal, "Investigacionfinal en xls_1.xlsx")
